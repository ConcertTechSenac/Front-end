  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.item} onPress={() => navegarPara('Carrinho')}>
          <Image source={require('../assets/carrinho.png')} style={styles.iconeMenu} resizeMode="contain" />
          <Text style={styles.itemTexto}>Meu Carrinho</Text>
        </TouchableOpacity>
